...
<html lang="en">
  ...
  <body class="bg-custom bg-cover h-screen ">
    ...
    <h1 class="text-3xl font-bold text-gray-900 mb-4">Booking</h1>
    ...
    <form id="bookingForm" class="max-w-md mx-auto" method="POST" action="">
      <div class="mb-4">
        <label for="customerName" class="block mb-1 text-gray-900">Customer Name:</label>
        <input
          type="text"
          id="customerName"
          name="customerName"
      ...
      <div class="mb-4">
        <label for="customerEmail" class="block mb-1 text-gray-900">Customer Email:</label>
        <input
          type="email"
          id="customerEmail"
          name="customerEmail"
      ...
      <div class="mb-4">
        <label for="bookingDate" class="block mb-1 text-gray-900">Booking Date:</label>
        <input
          type="date"
          id="bookingDate"
          name="bookingDate"
      ...
      <div class="mb-4">
        <label for="package" class="block mb-1 text-gray-900">Package:</label>
        <select
          id="package"
          name="package"
          required
